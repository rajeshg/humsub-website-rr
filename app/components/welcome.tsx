  ...
  return (
    <div id="container" className="container mx-auto px-4 max-w-7xl">
      <main className="flex flex-col dark:text-slate-100">
        {
          events.length > 0 && (
            <section className="flex flex-col md:flex-row gap-4 md:gap-8 md:mx-auto text-center not-prose rounded-lg bg-base-200/50 dark:bg-slate-800/70 p-4 shadow-sm">
                ...
                {events.map((event) => (
                  ...
                  >
                    ...
                    <span className="font-medium truncate text-left">
                      ...
                      {new Date(event.frontmatter?.startDate).toLocaleDateString(
                        "en-US",
                        {
                          day: "numeric",
                          month: "short",
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-2">
          ...
          >
            <div className="flex justify-center place-items-center bg-base-200 dark:bg-slate-700 rounded-lg p-4 shadow-inner">
              <div
                className="bg-gradient-to-r from-orange-500 via-gray-400 to-green-500 dark:from-orange-400 dark:via-gray-300 dark:to-green-400 inline-block text-transparent bg-clip-text text-2xl md:text-5xl font-bold p-2"
              >
                HUM SUB
              </div>
            </div>
        ...
        <section className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 my-4">
          <div
            className="card shadow-lg bg-gradient-to-r from-base-100 to-base-300 dark:from-slate-700 dark:to-slate-800 border border-base-300 dark:border-slate-600 hover:border-primary dark:hover:border-amber-400 transition-all hover:-translate-y-1"
          >
          ...
          <div
            className="card shadow-lg bg-gradient-to-r from-base-100 to-base-300 dark:from-slate-700 dark:to-slate-800 border border-base-300 dark:border-slate-600 hover:border-secondary dark:hover:border-teal-400 transition-all hover:-translate-y-1"
          >
            <div className="card-body">
        ...
        <section className="shadow-lg rounded-xl bg-base-100 dark:bg-slate-800 p-4 my-4 grid grid-cols-2 md:grid-cols-4 gap-4">
          <div className="relative bg-base-200/50 dark:bg-slate-700/70 rounded-lg p-4 flex flex-col">
            ...
            <div className="text-xs text-gray-700 dark:text-slate-200 mt-1">
