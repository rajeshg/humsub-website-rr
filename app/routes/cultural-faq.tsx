	...
	return (
		<div className="flex flex-col gap-2">
			...
			<div className="collapse collapse-arrow bg-base-100 border border-base-300">
				...
				<div className="collapse-title font-semibold">What is the timeline for Basant Bahar event?</div>
				<div className="collapse-content text-sm">
					...
					<p>
						For more details, please check our event calendar at <a href="/events/">https://humsub.org/events/</a>
					</p>
				</div>
			</div>
			...
			<div className="collapse collapse-arrow bg-base-100 border border-base-300">
				...
				<div className="collapse-title font-semibold">What is the timeline for Hum Sub Diwali event?</div>
				<div className="collapse-content text-sm">
					...
					<p>
						...
						<a href="https://humsub.org/events/">https://humsub.org/events/</a>
					</p>
				</div>
			</div>
			...
			<div className="collapse collapse-arrow bg-base-100 border border-base-300">
				<input type="radio" name="my-accordion-2" />
				<div className="collapse-title font-semibold">Is there a minimum age requirement for a participant?</div>
				<div className="collapse-content text-sm">
			...
			<div className="collapse collapse-arrow bg-base-100 border border-base-300">
				<input type="radio" name="my-accordion-2" />
				<div className="collapse-title font-semibold">What exactly is the theme about ?</div>
				<div className="collapse-content text-sm">
					...
					are a reflection of the times. Choreographers are encouraged to be as creative as possible in interpreting the
					theme.
				</div>
			</div>
			...
			<div className="collapse collapse-arrow bg-base-100 border border-base-300">
				<input type="radio" name="my-accordion-2" />
				<div className="collapse-title font-semibold">Is there any limit to the number of participants ?</div>
				<div className="collapse-content text-sm">
					The Committee has only set a minimum number of participants, as the Hum Sub Diwali stage is a big stage. There
					is no upper limit.
				</div>
			</div>
			...
			<div className="collapse collapse-arrow bg-base-100 border border-base-300">
				<input type="radio" name="my-accordion-2" />
				<div className="collapse-title font-semibold">How to subscribe or unsubscribe from cultural mailing list</div>
				<div className="collapse-content text-sm">
					Send email to <a href="mailto:cultural_programs@humsub.net">cultural_programs@humsub.net</a>
				</div>
			</div>
		</div>
	)
