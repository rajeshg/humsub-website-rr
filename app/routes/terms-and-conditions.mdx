...
- **Application** means the software program provided by the Company downloaded by You on any electronic device, named Hum Sub
...
- **Company** (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to HUM Sub, Inc, 307 Swordgate Drive, Cary, NC 27513.
...
- **Website** refers to Hum Sub, accessible from [https://humsub.org](https://humsub.org)
