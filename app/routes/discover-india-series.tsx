    ...
    return (
        <div>
            ...
            <section>
                <h2>Madhubani Art</h2>
                <p>
                    Madhubani art, known for their fine, intricate patterns, often featuring themes from nature, mythology, and folklore, is believed to have been first developed by women in rural Bihar, India, to decorate the walls of their homes, especially during weddings and special occasions. Want to learn more about it? Register for this free workshop.
                </p>
                <p>
            ...
            <section>
                ...
                <p>
                    Mindfulness emphasizes being fully present in the moment, observing thoughts and feelings without judgment, and responding to situations with awareness. Decades of neuroscience studies show the power of mindfulness to relieve stress, awaken our positive capacities, and bring balance to our lives. Mindfulness gives us the power to meet any situation wisely, to be fully present, and to operate with compassion.
                </p>
                <p>
                    Did you know that the gut is often called the “second brain”? In this session, we’ll dive into the fascinating world of gut health, exploring how the gut-brain connection impacts overall well-being. Discover how daily choices—like food, stress management, and lifestyle—affect your gut, and learn simple, effective ways to restore balance. Walk away with practical insights to nurture your gut and boost overall well-being.
                </p>
                <p>
            ...
            <section>
                ...
                <p>
                    Puppet shows remain a favorite form of storytelling in India to this day. Traditionally, Indian mythology has been passed down generations through the spoken rather than written word. Indian society has relied heavily on stories to sustain its culture and identity. Come and enjoy this unique session that will take an innovative approach to tell a well-loved tale through puppets.
                </p>
                <p>
