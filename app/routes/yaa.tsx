  ...
  return (
    <div className="prose dark:prose-invert max-w-none">
      ...
      <div className="not-prose">
        ...
        <div className="flex flex-col items-center px-4 py-6 border border-gray-200 dark:border-gray-700 rounded-lg shadow-sm bg-white dark:bg-gray-800 mb-8">
          <img
        ...
        <img
          ...
          className="max-h-48 justify-center block mx-auto object-contain transition-transform duration-300 hover:scale-110 mb-12"
      ...
      <div className="space-y-12">
        ...
        <section>
          <h2 className="text-2xl font-bold border-b pb-2 mb-6">2023 WINNERS</h2>
        ...
        <section>
          <h2 className="text-2xl font-bold border-b pb-2 mb-6">2022 WINNERS</h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
        ...
        <section>
          <h2 className="text-2xl font-bold border-b pb-2 mb-4">2021 WINNERS</h2>
        ...
        <section>
          <h2 className="text-2xl font-bold border-b pb-2 mb-4">2020 WINNERS</h2>
          <ul className="list-disc pl-6 mb-6">
            <li>Uma Bhat</li>
          </ul>
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
        ...
        <section>
          <h2 className="text-2xl font-bold border-b pb-2 mb-4">2019 WINNERS</h2>
        ...
        <section>
          <h2 className="text-2xl font-bold border-b pb-2 mb-6">2018 WINNERS</h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4">
        ...
        <section>
          <h2 className="text-2xl font-bold border-b pb-2 mb-6">2017 WINNERS</h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4">
        ...
        <section>
          <h2 className="text-2xl font-bold border-b pb-2 mb-4">2016 WINNERS</h2>
          <ul className="list-disc pl-6">
            <li>Shaily Shah</li>
        ...
        <section>
          <h2 className="text-2xl font-bold border-b pb-2 mb-4">2015 WINNERS</h2>
          <ul className="list-disc pl-6">
            <li>Meghana</li>
            <li>Arjun Arora</li>
        ...
        <section>
          <h2 className="text-2xl font-bold border-b pb-2 mb-4">2014 WINNERS</h2>
          <ul className="list-disc pl-6">
